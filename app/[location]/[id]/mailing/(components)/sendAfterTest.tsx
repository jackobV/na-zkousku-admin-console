...
export default function SendAfterTest({wasSent, mailingList, testId}:{wasSent:boolean, mailingList:mailingList,testId:string}){
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        const response = await fetch('/api/mail', {
            ...
            body: JSON.stringify({type:"afterTest",emails:updatedMailingList,testId:testId}),
        });
    ...
    return(
        <>
            <div className="grid grid-cols-8">
                <div className="col-span-4">Mail s informacemi po testu</div>
                        ...
                        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                            ...
                            >
                                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                                    <div>
                                        Zaslat Mail s informacemi po testu
                                    </div>
