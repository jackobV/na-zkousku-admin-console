...
export default function SendMarksAvailable({wasSent, mailingList, testId}:{wasSent:boolean, mailingList:mailingList,testId:string}){
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        const response = await fetch('/api/mail', {
            ...
            body: JSON.stringify({type:"marksavailable",emails:updatedMailingList,testId:testId}),
        });
    ...
    return(
        <>
            <div className="grid grid-cols-8">
                <div className="col-span-4">Mail s oznámením dostupnosti známek</div>
